...
The library is at a state where the functionality has been verified to work correctly and is stable enough to work in a production environment - with the exception of scattered multi docs. However, until the release of version 1.0 (planned for March), some API changes may occur.
